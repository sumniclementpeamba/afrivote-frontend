  ...
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans overflow-x-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-2xl border-b border-slate-200/60 dark:border-slate-800/80 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3 cursor-pointer">
              <div className="p-2 bg-gradient-to-tr from-indigo-600 via-indigo-700 to-purple-600 rounded-2xl shadow-lg shadow-indigo-500/20">
                <Zap className="w-5 h-5 text-white" />
              </div>
              <span className="text-2xl font-black text-indigo-600 dark:text-white tracking-tight">AfriVote</span>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-slate-200/60 dark:border-slate-800/80 bg-white/95 dark:bg-slate-950/95 backdrop-blur-2xl overflow-hidden px-4 pt-4 pb-6 space-y-3">
            <Link
              href="/register"
      ...
      <section className="relative pt-28 sm:pt-36 pb-16 sm:pb-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-100 dark:border-indigo-900 text-indigo-700 dark:text-indigo-300 text-xs font-bold mb-6 shadow-sm">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 mb-10 leading-relaxed max-w-xl font-medium">
              ...
              <div className="flex flex-wrap gap-6 mt-12 pt-8 border-t border-slate-200/60 dark:border-slate-800/60">
                {[
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={label} className="space-y-1">
                <div className="text-3xl sm:text-4xl font-black text-indigo-600 dark:text-white">
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="text-indigo-600 dark:text-indigo-400 font-extrabold text-xs tracking-[0.2em] uppercase">Simple Process</span>
            <h2 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight mt-2 mb-4">How AfriVote Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={idx} className="relative z-10">
                <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 text-center relative overflow-hidden group">
      ...
      <section className="py-24 bg-white dark:bg-slate-900/60 border-y border-slate-200/60 dark:border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <span className="text-indigo-600 dark:text-indigo-400 font-extrabold text-xs tracking-[0.2em] uppercase">Platform Capabilities</span>
            <h2 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight mt-2 mb-4">Everything You Need</h2>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-indigo-600 dark:text-indigo-400 font-extrabold text-xs tracking-[0.2em] uppercase">For Administrators</span>
            <h2 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight mt-2 mb-4">Admin Operations Lifecycle</h2>
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 max-w-xl mx-auto">
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-gradient-to-tr from-indigo-950 via-indigo-900 to-purple-950 rounded-[2.5rem] shadow-2xl text-center py-16 px-6 sm:px-14 overflow-hidden border border-indigo-800/40">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.1),transparent)] pointer-events-none" />
            <h2 className="text-3xl sm:text-5xl font-black text-white mb-5 relative z-10 tracking-tight">
      ...
      <section className="py-24 bg-white dark:bg-slate-900/40 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-indigo-600 dark:text-indigo-400 font-extrabold text-xs tracking-[0.2em] uppercase">The Builders</span>
          <h2 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight mt-2 mb-3">Meet Our Engineering Team</h2>
