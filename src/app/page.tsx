...
const VoteMockup = () => (
  ...
  >
    ...
    <div className="relative bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 dark:border-slate-800 overflow-hidden transition-all duration-300">
      <div className="bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-700 px-5 py-4 flex items-center justify-between shadow-sm mobile-solid-bg">
      ...
      <div className="px-6 pb-6">
        <button className="w-full bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-600 text-white font-extrabold py-3 rounded-2xl text-xs text-center shadow-xl shadow-indigo-500/20 hover:shadow-indigo-500/30 active:scale-95 transition-all mobile-solid-bg">
          Submit Ballot Token
        </button>
      </div>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3 cursor-pointer">
              <motion.div whileHover={{ rotate: 12, scale: 1.05 }} transition={{ duration: 0.2 }} className="p-2 bg-gradient-to-tr from-indigo-600 via-indigo-700 to-purple-600 rounded-2xl shadow-lg shadow-indigo-500/20 mobile-solid-bg">
            ...
            {/* Desktop Actions */}
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="hidden md:flex items-center gap-2 sm:gap-3">
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link href="/vote/login" className="bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-5 py-2.5 rounded-2xl font-bold text-sm transition-all shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30 mobile-solid-bg">
                  Voter Sign In
                </Link>
              </motion.div>
            </motion.div>
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <Link
                href="/vote/login"
                onClick={() => setMobileMenuOpen(false)}
                className="block text-center font-extrabold text-white bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-600 py-3 rounded-2xl text-sm shadow-md shadow-indigo-500/20 mobile-solid-bg"
              >
                Voter Sign In
              </Link>
            </motion.div>
            ...
            {[
              ...
              <motion.div key={idx} variants={fadeUp} className="relative z-10">
                ...
                >
                  ...
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-indigo-500/20 group-hover:scale-110 transition-transform mobile-solid-bg">
            ...
            {FEATURES.map((f) => (
              <motion.button
                ...
                className={`flex items-center gap-2.5 px-6 py-3 rounded-2xl font-bold text-sm transition-all duration-200 ${
                  activeTab === f.id
                    ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-500/25 mobile-solid-bg'
            ...
            {[
              ...
              >
                <div className="shrink-0">
                  <div className={`p-4 bg-gradient-to-br ${step.from} ${step.to} rounded-2xl shadow-md text-white group-hover:scale-110 transition-transform mobile-solid-bg`}>
